    ...
    async fn get_repositories_to_track(&self) -> Result<Vec<Repository>> {
        ...
        let repositories = db
            ...
            .map(|row| Repository {
                ...
                contributing_guidelines_url: row.get("contributing_guidelines_url"),
    ...
    async fn update_repository_gh_data(&self, repository: &Repository) -> Result<()> {
        ...
        db.execute(
            ...
            &[
                ...
                &repository.contributing_guidelines_url,
